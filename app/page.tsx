...
const METRICAS_COMP = [
  { key: 'nps',       label: 'Probabilidad de volver (NPS)', ed1: 4.93, ed2: 4.56, ed3: 4.75 },
  { key: 'mentores',  label: 'Calidad de mentores',          ed1: 4.86, ed2: 4.89, ed3: 4.83 },
  { key: 'lugar',     label: 'Calidad del lugar',            ed1: 4.72, ed2: 4.33, ed3: 4.25 },
  { key: 'consigna',  label: 'Consigna y output esperado',   ed1: 4.31, ed2: 4.56, ed3: 4.00 },
  { key: 'comida',    label: 'Calidad de la comida',         ed1: 4.21, ed2: 4.28, ed3: 4.42 },
  { key: 'pitch',     label: 'Dinámica del pitch / presentación', ed1: 4.03, ed2: 4.06, ed3: 3.67 },
  { key: 'jueces',    label: 'Decisión de los jueces',       ed1: 4.17, ed2: 3.83, ed3: 4.17 },
...
function Footer() {
  return (
    <footer className="footer">
      ...
      <span>3 ediciones · {29 + 18 + 12} respuestas totales</span>
    </footer>
  )
}
...
export default function HomePage() {
  const heroMetrics = [
    { label: 'Mentores',     val: 4.83 },
    { label: 'Comida',       val: 4.42 },
    { label: 'Lugar',        val: 4.25 },
    { label: 'Jueces',       val: 4.17 },
    { label: 'Consigna',     val: 4.00 },
    { label: 'Presentación', val: 3.67 },
  ]
